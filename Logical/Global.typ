...
TYPE
	CMD_Type : 	STRUCT 
		...
		Write_EMAIL_DATA : CMD_Write_EMAIL_DATA_Type;
		Write_EMAIL_OPLOG : CMD_Write_EMAIL_OPLOG_Type;
		Write_DEFAULTALRM_RESET : CMD_Write_DEFAULTALRM_RESET_Type;
		Write_DEFAULTSYS_RESET : CMD_Write_DEFAULTSYS_RESET_Type;
		...
		Write_ENABLE_ROSTER1 : CMD_Write_ENABLE_ROSTER1_Type;
		Write_ENABLE_ROSTER2 : CMD_Write_ENABLE_ROSTER2_Type;
		Write_ENABLE_ROSTER3 : CMD_Write_ENABLE_ROSTER3_Type;
		Write_ENABLE_ROSTER4 : CMD_Write_ENABLE_ROSTER4_Type;
		Write_ENABLE_ROSTER5 : CMD_Write_ENABLE_ROSTER5_Type;
...
TYPE
	...
	CMD_Write_RECALC_CMD_Type : 	STRUCT 
		...
		wRECALC_CMD : UINT := 1;
	END_STRUCT;
	CMD_Write_EMAIL_DATA_Type : 	STRUCT 
		Send : BOOL;
		wEMAIL_DATA : UINT;
	END_STRUCT;
	CMD_Write_EMAIL_OPLOG_Type : 	STRUCT 
		Send : BOOL;
		wEMAIL_OPLOG : UINT := 1;
	END_STRUCT;
	CMD_Write_DEFAULTALRM_RESET_Type : 	STRUCT 
		Send : BOOL;
		wDEFAULTALRM_RESET : UINT := 1;
	END_STRUCT;
	CMD_Write_DEFAULTSYS_RESET_Type : 	STRUCT 
		Send : BOOL;
		wDEFAULTSYS_RESET : UINT := 1;
	END_STRUCT;
...
TYPE
	VisBool_Type : 	STRUCT 
		...
		CD101_TARGETHI : REAL;
		CD101_TARGETLO : REAL;
		ROSTER1_DISABLE : BOOL;
		ROSTER1_ENABLE : BOOL;
		ROSTER2_DISABLE : BOOL;
		ROSTER2_ENABLE : BOOL;
		ROSTER3_DISABLE : BOOL;
		ROSTER3_ENABLE : BOOL;
		ROSTER4_DISABLE : BOOL;
		ROSTER4_ENABLE : BOOL;
		ROSTER5_DISABLE : BOOL;
		ROSTER5_ENABLE : BOOL;
		ROSTER6_DISABLE : BOOL;
		ROSTER6_ENABLE : BOOL;
		ROSTER7_DISABLE : BOOL;
		ROSTER7_ENABLE : BOOL;
		ROSTER8_DISABLE : BOOL;
		ROSTER8_ENABLE : BOOL;
		ROSTER1_DIS : BOOL;
		ROSTER1_EN : BOOL;
		ROSTER2_DIS : BOOL;
	...
	VisNum_Type : 	STRUCT 
		...
		P104_TOTALADJ_IN : REAL;
		P201_TOTALADJ_IN : REAL;
		P202_TOTALADJ_IN : REAL;
		P203_TOTALADJ_IN : REAL;
		P101_TOTALADJ : REAL;
		P102_TOTALADJ : REAL;
		P103_TOTALADJ : REAL;
		P104_TOTALADJ : REAL;
		...
		P202_TOTALADJ : REAL;
		P203_TOTALADJ : REAL;
		P101_STEPADJ_IN : REAL;
		P102_STEPADJ_IN : REAL;
		P103_STEPADJ_IN : REAL;
		P104_STEPADJ_IN : REAL;
		P201_STEPADJ_IN : REAL;
		P202_STEPADJ_IN : REAL;
		P203_STEPADJ_IN : REAL;
		P101_STEPADJ : REAL;
		P102_STEPADJ : REAL;
		P103_STEPADJ : REAL;
		P104_STEPADJ : REAL;
